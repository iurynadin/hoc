    ...
    connectedCallback() {
        ...
        this.innerHTML = `
            <div class="group hover:cursor-pointer flex justify-start items-center transition-all duration-300">
                <div class="mr-[3px] leading uppercase ${textColor} font-gotham_bold text-lg xl:text-[20px] leading-tight group-hover:text-amarelopastel transition-all duration-300">${this.getAttribute('label')}</div>
